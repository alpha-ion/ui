---
title: تلميح (Tooltip)
description_ar: صندوق منبثق سهل الوصول وقابل للتكوين بدرجة عالية، يتميز بالتحكم الدقيق في الموضع ورسوم متحركة سلسة لتحسين المعلومات السياقية في الواجهة.
keywords_ar: [تلميح أدوات سهل الوصول, رسوم متحركة Radix, منبثق موضعي, مساعد UX]
links:
