...
description: يوفّر Scroll Area حاوية انسيابية للمحتوى الزائد مع دعم التمرير العمودي والأفقي، وخيار إخفاء شريط التمرير تلقائيًا. مثالي للبطاقات، الجوانب، والنصوص الطويلة.
links:
