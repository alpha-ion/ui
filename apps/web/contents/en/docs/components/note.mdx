---
title: Note
description: Animated, dismissible message component with Framer Motion integration. Features backdrop blur for a premium visual aesthetic across multiple context variants.
