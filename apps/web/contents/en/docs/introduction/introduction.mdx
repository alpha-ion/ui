...
You know how most traditional component libraries work: you install a package from Node.js packages (npm, yarn, pnpm) or even deno or bun, import the components, and use them in your app.
