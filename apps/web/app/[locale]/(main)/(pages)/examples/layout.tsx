    ...
    <div className="min-h-[81.6vh] py-10 md:py-14">
      <Container>
        ...
        <div className="hidden md:block">
          <PageNav id="examples" className="mt-2">
            <ExamplesNav className="[&>a:first-child]:text-primary flex-1 overflow-hidden" />
            {/* <ThemeSelector className="mr-4 hidden md:block" /> */}
            
          </PageNav>
          <div className="container-wrapper section-soft flex flex-1 flex-col pb-6 mt-4">
            <div className="theme-container container flex flex-1 scroll-mt-20 flex-col px-0">
