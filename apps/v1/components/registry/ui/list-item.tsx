...
const ListItemLocaleContext = createContext<LocaleType>("en")
const useListItemLocale = () => useContext(ListItemLocaleContext)
...
function ListItemGroup({ className, ...props }: React.ComponentProps<"div">) {
    ...
    return (
        <ListItemLocaleContext.Provider value={locale}>
            <div
                role="list"
                dir={dir}
                ...
                {...props}
            />
        </ListItemLocaleContext.Provider>
    )
}
...
function ListItem({
    ...
    const locale = useListItemLocale()
    const dir = locale === "ar" ? "rtl" : "ltr"
...
function ListItemMedia({
    ...
    return (
        <div
            ...
            data-variant={variant}
            className={cn(
                listItemMediaVariants({ variant }),
                // RTL Support - media should be on the right in RTL
                "ltr:mr-0 rtl:ml-0",
                className
            )}
            {...props}
...
function ListItemTitle({
    ...
    return (
        <div
            ...
            className={cn(
                " gap-2 text-sm leading-snug font-semibold text-foreground",
                // RTL Support
    ...
    return (
        <div
            ...
            className={cn(
                ...
                // RTL Support - actions should be on the left in RTL
