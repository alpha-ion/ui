...
export default function ComponentPreview({
  ...
  return (
    <Tabs defaultValue="preview" className="mt-4 relative">
      <TabsList
        dir={locale === "ar" ? "rtl" : "ltr"}
        className="inline-flex h-9 items-center text-muted-foreground w-full justify-start rounded-none border-b bg-transparent p-0 mb-2 relative z-0"
      >
      ...
      <div className="not-prose">
        <TabsContent value="preview" className={cn("min-h-[350px] h-auto border rounded-xl relative overflow-visible", className)}>
          <div className="overflow-visible hide-scrollbar">
            ...
            >
              {DynamicComponent ? (
                <div className={cn(
                  "preview flex min-h-[350px] w-full justify-center px-5 md:px-10 py-5 items-center overflow-visible",
                  containerClassName
                )}>
                  <DynamicComponent />
                </div>
        ...
        <TabsContent value="code" className="mt-0 relative z-0">
          {componentCode ? (
            <Pre
              raw={componentCode}
