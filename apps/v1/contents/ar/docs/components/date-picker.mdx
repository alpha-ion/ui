...
slug: /docs/components/data-picker
description_ar: أداة تحكم موحدة وعالية الكفاءة لإدخال البيانات الزمنية الدقيقة، مُصممة لأقصى فعالية للنماذج. يدمج منطق اختيار التقويم والإدخال في مكون واحد مُترابط، مع دعم وظائف **نطاق التاريخ** المتقدمة.
keywords: [مُحدد تاريخ, إدخال زمني, فعالية النماذج, نطاق تاريخ, إدخال موحد]
---
...
### محدد التواريخ (Date Picker Range)

<ComponentPreview name="date-picker-demo" variant="range" />

### محدد تاريخ باللغة العربية
