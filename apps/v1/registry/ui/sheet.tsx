...
const SheetLocaleContext = createContext<LocaleType>("en")
const useSheetLocale = () => useContext(SheetLocaleContext)
...
>(({ children, ...props }, ref) => {
  ...
  return (
    <SheetLocaleContext.Provider value={locale}>
      <SheetPrimitive.Root {...props}>
        {children}
      </SheetPrimitive.Root>
    </SheetLocaleContext.Provider>
  )
})
    ...
    <SheetPortal>
      ...
      >
        ...
        <SheetPrimitive.Close
          className={cn(
            "ring-offset-background focus:ring-ring data-[state=open]:bg-secondary absolute top-4 rounded-sm opacity-70 transition-opacity hover:opacity-100 focus:ring-2 focus:ring-offset-2 focus:outline-none disabled:pointer-events-none",
