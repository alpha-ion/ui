...
const ContextMenuLocaleContext = React.createContext<LocaleType>("en")
const useContextMenuLocale = () => React.useContext(ContextMenuLocaleContext)

const ContextMenu: React.FC<React.ComponentProps<typeof ContextMenuPrimitive.Root>> = ({ children, ...props }) => {
